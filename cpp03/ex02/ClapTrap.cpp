...
ClapTrap::ClapTrap(std::string name, int hitPoints, int energyPoints, int attackDamage) : _name(name), _hitPoint(hitPoints), _energyPoints(energyPoints), _attackDamage(attackDamage){
	std::cout << "ClapTrap: String constructor called for: " << _name << std::endl;
	return ;
}
